 ...
 * ----------------------|-------------|--------
 * `--atp-step-content-style` | Style mixin of the step content | `{}`
 * `--atp-step-continue-btn-color` | Continue button color | `--google-blue-500`
 *
 * @customElement
 * @polymer
 * @memberof AtpDeveloper
 */
class AtpStepElement extends PolymerElement {
    ...
    <style include="paper-material-styles">
      ...
      #actions ::slotted(.continue-btn) {
        color: var(--atp-step-continue-btn-color, var(--google-blue-500));
        background-color: var(--atp-step-continue-back-color, var(--google-grey-100));
      }
    ...
    <div id="actions">
      ...
      <div class="linear-actions">
        <slot name="linear-actions" id="linearActionsSlot">
          ...
          <paper-button data-action="continue" class="continue-btn">Continuar</paper-button>
        </slot>
      </div>
    </div>
    ...
    static get properties() {
        return {
            ...
            _currentIcon: {
                type: String,
                computed: '_computeCurrentIcon(completed, editable, error, icon)',
                notify: true
            },
    ...
    _computeCurrentIcon(completed, editable, error, icon) {
...
window.customElements.define(AtpStepElement.is, AtpStepElement);

/**
 * @namespace AtpDeveloper
 */
window.AtpDeveloper = window.AtpDeveloper || {};
AtpDeveloper.AtpStepElement = AtpStepElement;