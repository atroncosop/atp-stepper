 ...
 * ----------------------|-------------|--------
 * `--atp-stepper-header-container-style` | Style mixin for the header container | `{}`
 * `--atp-stepper-icon-completed-color` | The icon color of a completed step | `--google-blue-500`
 * `--atp-stepper-icon-error-color` | The icon color of a step with error | `--paper-deep-orange-a700`
 * `--atp-stepper-icon-seleced-color` | The icon color of a selected step | `--google-blue-500`
 *
 * @customElement
 * @polymer
 ...
 */
class AtpStepperElement extends MutableData(PolymerElement) {
    static get template() {
        return html `
    ...
    _findSteps() {
        return Array.from(this.querySelectorAll('atp-step'));
    }
    ...
    _isStep(node) {
        return node.nodeType === Node.ELEMENT_NODE && /atp-step/i.test(node.localName);
    }
...
window.customElements.define(AtpStepperElement.is, AtpStepperElement);

/**
 * @namespace AtpDeveloper
 */
window.AtpDeveloper = window.AtpDeveloper || {};
AtpDeveloper.AtpStepperElement = AtpStepperElement;